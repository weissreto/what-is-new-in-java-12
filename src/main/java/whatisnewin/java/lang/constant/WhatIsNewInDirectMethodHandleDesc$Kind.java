...
public final class WhatIsNewInDirectMethodHandleDesc$Kind
{
  ...
  /**
   * Example call to new method {@link Kind#valueOf(int)}.
   * @since 12
   * @see Kind#valueOf(int)
   */
  ...
  /**
   * Example call to new method {@link Kind#valueOf(int, boolean)}.
   * @since 12
   * @see Kind#valueOf(int, boolean)
   */
