...
{
  /**
   * Example call to new method {@link ClassDesc#of(String)}.
   * @since 12
  ...
  /**
   * Example call to new method {@link ClassDesc#of(String, String)}.
   * @since 12
   * @see ClassDesc#of(String, String)
   */
  ...
  /**
   * Example call to new method {@link ClassDesc#arrayType(int)}.
   * @since 12
   * @see ClassDesc#arrayType(int)
   */
