...
{
  /**
   * Example call to new method {@link MethodHandleDesc#of(Kind, ClassDesc, String, String)}.
   * @since 12
   * @see MethodHandleDesc#of(Kind, ClassDesc, String, String)
   */
  ...
  /**
   * Example call to new method {@link MethodHandleDesc#ofField(Kind, ClassDesc, String, ClassDesc)}.
   * @since 12
   * @see MethodHandleDesc#ofField(Kind, ClassDesc, String, ClassDesc)
   */
  ...
  /**
   * Example call to new method {@link MethodHandleDesc#asType(MethodTypeDesc)}.
   * @since 12
   * @see MethodHandleDesc#asType(MethodTypeDesc)
   */
