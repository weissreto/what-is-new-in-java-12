...
public final class WhatIsNewInInteger
{
  ...
  /**
   * Example call to new method {@link Integer#resolveConstantDesc(Lookup)}.
   * @since 12
   * @see Integer#resolveConstantDesc(Lookup)
   */
  public Integer resolveConstantDesc(Lookup lookup)
  {
    Integer testee = $$$();

    Integer result = testee.resolveConstantDesc(lookup);
    return result;
  }
